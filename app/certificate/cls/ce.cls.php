...
class ce_certificate
{
    ...
    public function getEmployeeList($beginIndex=0,$number = 20,$ceid) //获取所有的员工列表
    {
        $r = $this->db->queryEmpList($beginIndex,$number,$ceid); //pepdo.cls.php
        return $r;
    }

    public function getDeptList() //获取所有部门
    {
        $r = $this->db->queryDeptList(); //pepdo.cls.php
        return $r;
    }
