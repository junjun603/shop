							...
							<td class="actions" style="text-align: center">
								<div class="btn-group">
									<!---
			                    	    ...
			                    	    -->
									<a class="btn btn-xs btn-primary" href="index.php?certificate-master-certificate-queue&ceid={x2;v:certificate['ceid']}&page={x2;$page}{x2;$u}" title="发证">发证</a>
									<a class="btn btn-xs btn-info" style="margin-left: 5px;margin-right: 5px;" href="index.php?certificate-master-certificate-modify&ceid={x2;v:certificate['ceid']}&page={x2;$page}{x2;$u}" title="修改">修改</a>
									<a class="btn btn-xs confirm btn-danger" href="index.php?certificate-master-certificate-del&ceid={x2;v:certificate['ceid']}&page={x2;$page}{x2;$u}" title="删除">删除</a>
								</div>
							</td>
						</tr>
						{x2;endtree}
