			...
			<div class="col-xs-2" style="padding-top:10px;margin-bottom:0px;">
				<div class="panel panel-primary">
					<div id="panel-element-212076" class="panel-collapse{x2;if:$method == 'questions' || $method == 'rowsquestions' || $method == 'feedback'} in{x2;endif} collapse" role="tabpanel">
			     		<ul class="list-group">
							<li class="list-group-item"><a href="index.php?{x2;$_app}-app-questions">普通试题管理</a></li>
							<!--
							<li class="list-group-item active"><a href="index.php?{x2;$_app}-app-questions-questionrows">题帽题管理</a></li>
							-->
						</ul>
					</div>
				</div>
