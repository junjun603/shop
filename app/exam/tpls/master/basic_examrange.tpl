				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
			        ...
			        <form action="?exam-master-basic-setexamrange" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-9 form-inline">
								<input size="50" class="form-control" type="text" id="basicexam_allowgroup" name="args[basicexam][allowgroup]" value="{x2;$basic['basicexam']['allowgroup']}" />
								<a class="selfmodal btn btn-primary" href="javascript:;" data-target="#modal" url="index.php?exam-master-basic-selectgroups&groups={basicexam_allowgroup}&useframe=1&target=basicexam_allowgroup" valuefrom="basicexam_allowgroup">选组</a>
								<!--
