...
class action extends app
{
	...
	private function open() //开通新考场
	{
        ...
        // 根据用户id查询可以开通的考场
        $basics['data'] = $this->db->authCourse($_SESSION['currentuser']['sessionuserid'],$basics['data']);
        if(count($basics['data'])<1){
            $this->tpl->assign('errors',1);
