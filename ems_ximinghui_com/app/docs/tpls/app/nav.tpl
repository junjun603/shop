					...
					<div class="input-group">
						<div class="input-group-btn">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="index.php?docs-app">百科</a></li>
							</ul>
						</div>
						<input type="text" style="width:380px;" class="form-control" id="keyword" placeholder="搜索百科">
					</div>
		...
		<div class="main">
			<div class="col-xs-12">
				<ul class="list-unstyled list-inline">
					...
					<li class="menu col-xs-1 active"><a href="index.php?docs">百科</a></li>
